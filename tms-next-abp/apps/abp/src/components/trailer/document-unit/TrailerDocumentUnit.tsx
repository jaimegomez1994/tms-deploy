...
import { TrailerDocumentUnitService } from '@tms_next_abp/proxy';
import DocumentUnit from '../../shared/document-unit/DocumentUnit';

export default function TrailerDocumentUnit(props) {
    ...
    function getDocumentUnits(parentId) {
        setLoading(true);
        TrailerDocumentUnitService.documentUnitsGetList(parentId)
            .then((data) => {
    ...
    function deleteDocumentUnit(docId) {
        TrailerDocumentUnitService.deleteDocumentUnit(docId, parentId)
    ...
    function addDocumentUnit(documentUnit) {
        TrailerDocumentUnitService.addDocumentUnit(
            parentId,
