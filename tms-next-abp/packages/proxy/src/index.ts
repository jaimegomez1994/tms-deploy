...
export type { ClientManagerDto } from './models/ClienManagmentDto';
...
export type { LicenseHolderDto } from './models/LicenseHolderDto';
export type { ContractDto } from './models/ContractDto';
export type { AddressDto } from './models/AddressDto';
export type { OperatorDto } from './models/OperatorDto';
...
export { ClientManagerService } from './services/ClientManagmentService';
...
export { OperatorBankAccountService } from './services/OperatorBankAccountService';
export { OperatorAddressService } from './services/OperatorAddressService';
export { RouteService } from './services/RouteService';
export { TractorTruckService } from './services/TractorTruckService';
export { TractorTruckDocumentUnitService } from './services/TractorTruckDocumentUnitService';
export { TrailerDocumentUnitService } from './services/TrailerDocumentUnitService';
export { TrailerTypeService } from './services/TrailerTypeService';
export { ArticulatedUnitTypeService } from './services/ArticulatedUnitTypeService';
export { AccessoryUnitService } from './services/AccessoryUnitService';
export { TrailerService } from './services/TrailerService';
export { ArticulatedUnitService } from './services/ArticulatedUnitService';
export { LicenseHolderService } from './services/LicenseHolderService';
