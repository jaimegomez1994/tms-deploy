    ...
    return (
        <Head>
            ...
            <meta
                ...
                content={
                    props.image ||
                    'https://reactyour-api-name.com/img/og-image.png'
                }
            />
            <meta
                key="url"
                name="url"
                content={props.url || 'https://reactyour-api-name.com'}
            />
            ...
            <meta
                key="ogUrl"
                name="ogUrl"
                content={props.ogUrl || 'https://reactyour-api-name.com'}
            />
            <meta
                key="ogSiteName"
                name="ogSiteName"
        ...
        canonical={props.url || "https://reactyour-api-name.com"}
        openGraph={{
          url: props.url || "https://reactyour-api-name.com",
